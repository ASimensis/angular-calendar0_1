...
import { AddGroupSheetComponent } from './components/add-group-sheet/add-group-sheet.component';
import { AddUserGroupSheetComponent } from './components/add-user-group-sheet/add-user-group-sheet.component';
...
@NgModule({
  declarations: [
    ...
    AddGroupSheetComponent,
    AddUserGroupSheetComponent,
